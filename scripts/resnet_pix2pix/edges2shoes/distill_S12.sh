...
python distill.py --dataroot database/edges2shoes-r \
  ...
  --log_dir logs/resnet_pix2pix/edges2shoes-r/distill_S12 \
  --num_teacher 2 --n_share 3 \
  --real_stat_path real_stat/edges2shoes-r_B.npz \
  --teacher_ngf 48 --teacher_ngf_1 12 --student_ngf 12 --ndf 96 \
  --teacher_netG mobile_resnet_9blocks --teacher_netG_1 mobile_deepest_resnet \
